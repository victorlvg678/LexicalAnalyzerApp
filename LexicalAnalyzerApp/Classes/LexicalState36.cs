...
{
    public class LexicalState36 : LexicalStateBase
    {
        #region constructors
        public LexicalState36(LexicalAnalyzer lexicalAnalyzer) : base(lexicalAnalyzer)
        {
        ...
        public override void getNextState(char symbol)
        {
            if (symbol == 'l')
            {
                _lexicalAnalyzer.changeState(new LexicalState37(_lexicalAnalyzer));
                return;
            }
