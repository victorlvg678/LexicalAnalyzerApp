...
{
    public class LexicalState24 : LexicalStateBase
    {
        #region constructors
        public LexicalState24(LexicalAnalyzer lexicalAnalyzer) : base(lexicalAnalyzer)
        {
        ...
        public override void getNextState(char symbol)
        {
            if (symbol == 'e')
            {
                _lexicalAnalyzer.changeState(new LexicalState25(_lexicalAnalyzer));
                return;
            }
