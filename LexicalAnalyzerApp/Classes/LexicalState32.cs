...
{
    public class LexicalState32 : LexicalStateBase
    {
        #region constructors
        public LexicalState32(LexicalAnalyzer lexicalAnalyzer) : base(lexicalAnalyzer)
        {
        ...
        public override void getNextState(char symbol)
        {
            if (symbol == 'l')
            {
                _lexicalAnalyzer.changeState(new LexicalState33(_lexicalAnalyzer));
                return;
            }
